    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-4 mx-50">
                <h1 class="address-title text-center mb-1" id="addNewAddressTitle">Tambah Iuran</h1>

                <form class="row gy-1 gx-2" method="POST" action="{{ route('manage-dues.store') }}"
                    ...
                    <div class="col-12 col-md-12">
                        <label class="form-label" for="description">Deskripsi iuran <small
                                class="text-danger">*</small></label>
