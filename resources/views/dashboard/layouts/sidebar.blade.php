<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    <li class="nav-item active"><a class="d-flex align-items-center" href="{{ route('dashboard.home') }}"><i
            ...
            <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="d-flex align-items-center"
                            ...
                            target="_blank"><span class="menu-item text-truncate" data-i18n="Verify Email">Verify
                                Email</span></a>
                    </li>
                    <li><a class="d-flex align-items-center"
            ...
            <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span
                ...
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="#"><span class="menu-item text-truncate"
                                data-i18n="Third Level">Third Level
                                3.1</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="#"><span class="menu-item text-truncate"
                                data-i18n="Third Level">Third Level
    ...
    <li class="disablednav-item"><a class="d-flex align-items-center" href="#"><i
