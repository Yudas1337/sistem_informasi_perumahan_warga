...
class StoreRequest extends BaseRequest
{
    ...
    {
        return [
            'nik'               => 'required|regex:/^[0-9]*$/|min:10|unique:denizens',
            'name'              => 'required|regex:/^[a-z-A-Z_\s\.]*$/|min:3',
            'phone_number'      => 'nullable|min:3|regex:/^[0-9]*$/|unique:denizens',
            ...
            'photo'             => 'required|file|image|max:2048|mimes:jpg,png,jpeg',
